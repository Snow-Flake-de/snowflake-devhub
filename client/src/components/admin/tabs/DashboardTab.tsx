  ...
  const statCards = [
    {
      ...
      details: [
        ...
        { label: 'Pending', value: stats?.users.pendingApprovals || 0 },
      ],
    },
    {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-lg p-4">
        <h3 className="text-sm font-semibold mb-3">Risk Alerts</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded border border-light-border dark:border-dark-border p-3">
            <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Pending approvals</p>
            <p className="text-lg font-semibold">{stats?.riskAlerts?.pendingApprovals || 0}</p>
          </div>
          <div className="rounded border border-light-border dark:border-dark-border p-3">
            <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Suspended users</p>
            <p className="text-lg font-semibold">{stats?.riskAlerts?.suspendedUsers || 0}</p>
          </div>
          <div className="rounded border border-light-border dark:border-dark-border p-3">
            <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Locked users</p>
            <p className="text-lg font-semibold">{stats?.riskAlerts?.lockedUsers || 0}</p>
          </div>
        </div>
      </div>
    </div>
