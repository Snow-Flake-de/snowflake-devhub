...
export const SnippetCard: React.FC<SnippetCardProps> = ({
  ...
  return (
    <>
      ...
      >
        {((snippet.visibility || (snippet.is_public === 1 ? 'PUBLIC' : 'PRIVATE')) !== 'PRIVATE' ||
          snippet.updated_at ||
          snippet.is_pinned === 1 ||
          ...
          <div className="flex items-center justify-between px-3 py-1 text-xs rounded-t-lg bg-light-hover/50 dark:bg-dark-hover/50">
            <div className="flex items-center gap-2">
              {(snippet.visibility || (snippet.is_public === 1 ? 'PUBLIC' : 'PRIVATE')) === 'PUBLIC' && (
              ...
              {(snippet.visibility === 'SHARED' || snippet.visibility === 'TEAM') && (
        ...
        <div className="p-4 pt-2">
          ...
          {!compactView && (
            <p className="mb-3 text-sm text-light-text dark:text-dark-text line-clamp-1">
              <ReactMarkdown skipHtml className={`markdown prose max-w-none`}>
