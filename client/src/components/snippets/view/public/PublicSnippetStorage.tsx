...
const PublicSnippetStorage: React.FC = () => {
  ...
  if (authConfig?.communityMode === "OFF") {
    return (
      <div className="min-h-screen p-8 bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text flex items-center justify-center">
        <div className="text-center space-y-2">
          <h2 className="text-xl font-semibold">Community mode is disabled</h2>
          <p className="text-light-text-secondary dark:text-dark-text-secondary">
            Public library endpoints are currently unavailable.
          </p>
        </div>
      </div>
    );
