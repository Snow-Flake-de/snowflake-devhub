...
router.get("/", requirePermission(Permissions.SNIPPET_READ_SELF), async (req, res) => {
  try {
...
router.post("/", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
...
router.delete("/:id", requirePermission(Permissions.SNIPPET_DELETE_SELF), async (req, res) => {
  try {
...
router.patch("/:id/restore", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
...
router.patch("/:id/recycle", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
...
// GET metadata
router.get("/metadata", requirePermission(Permissions.SNIPPET_READ_SELF), async (req, res) => {
  try {
...
router.put("/:id", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
...
router.get("/:id/:fragmentId/raw", requirePermission(Permissions.SNIPPET_READ_SELF), async (req, res) => {
  try {
...
router.get("/:id", requirePermission(Permissions.SNIPPET_READ_SELF), async (req, res) => {
  try {
...
// Pin/unpin snippet
router.patch("/:id/pin", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
...
router.patch("/:id/favorite", requirePermission(Permissions.SNIPPET_WRITE_SELF), async (req, res) => {
  try {
